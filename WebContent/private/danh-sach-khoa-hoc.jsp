        ...
        <div class="blog">
            <div class="row">
                     ...
                     <table class="table table-hover">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>T6 - CN</td>
                            <td>18h00 - 21h00</td>
                            <td><a type="button" class="btn btn-primary btn-sm">Sửa</a></td>
                            <td><a href="chi-tiet-khoa-hoc.html" class="btn btn-primary btn-sm">Chi tiết</a></td>
                          </tr>
                          <tr>
                            <td>LAND1609E2</td>
                            <td>Lập trình Java Android</td>
                            ...
                            <td>18h00 - 21h00</td>
                            <td><a type="button" class="btn btn-primary btn-sm">Sửa</a></td>
                            <td><a href="chi-tiet-khoa-hoc.html" type="button" class="btn btn-primary btn-sm">Chi tiết</a></td>
                          </tr>
                          <tr>
                            <td>LAND1609E2</td>
                            <td>Lập trình Java Android</td>
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-primary btn-sm">Xuất danh sách</button>
