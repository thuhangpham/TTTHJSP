...
<head>
    ...
    <title>Cập nhật khóa học | TTTH</title>
...
<div class="row">
  ...
  <div class="mtb wow fadeInDown">
    <h2 >Quản lý khóa học</h2><hr>

    <div class="main-content-wrap">
      <div class="main-content">

        <div class="list-wrap">
          <h3 class="form-title">Danh sách khóa học</h3>
          <form>
          <table class="list-table">
            ...
            <tr>
              ...
              <td>Giá trị 1.5</td>
              <td>Giá trị 1.6</td>
              <td class="edit-cell"><a class="btn-edit" href="qtnd_trangchu_khoahoc.jsp">Sửa</a></td>
