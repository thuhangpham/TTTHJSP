...
<head>
    ...
    <title>Chỉnh sửa thông tin giảng viên | TTTH</title>
...
<div class="row">
    ...
    <div class="col-sm-10">
     <div class=" mtb wow fadeInDown"> 
             <h2 >Chỉnh sửa thông tin Giảng viên</h2><hr> 
            	<ul>
                        <li>
                            <div class="form-group">
                             <legend>Thay đổi ảnh</legend> 
                            <img src="../assets/images/man1.jpg" class="img-thumbnail">  
                            </div>  
                             ...
                             <form  class="form-inline" action="" method="POST" role="form">
                               <div>
                                ...
                                <div>
                                 ...
                                 <div>
                                    <label class="fieldinput col-sm-2 control-label">Chuyên ngành
                                    <sup style="color: rgb(255, 0, 0);">*</sup></label>
                                    <div class="col-sm-10">
                                    <input type="text"  class="form-control" id="" value="" size="80" placeholder="Chuyên ngành" required="" autofocus="">
                                    </div>
                                </div><br>
                                <div >
