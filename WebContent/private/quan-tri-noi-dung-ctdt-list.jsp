...
<head>
    ...
    <title>Cập nhật chương trình đào tạo | TTTH</title>
...
<div class="row">
  ...
  <div class="mtb wow fadeInDown">
    <h2 >Quản lý chương trình đào tạo</h2><hr>

    <div class="main-content-wrap">
      <div class="main-content">

        <div class="list-wrap">
          <h3 class="form-title">Danh sách chương trình đào tạo</h3>
          <form>
          <table class="list-table">
            ...
            <tr>
              ...
              <td>Giá trị 1.5</td>
              <td>Giá trị 1.6</td>
              <td class="edit-cell"><a class="btn-edit" href="qtnd_trangchu_ctdaotao.jsp">Sửa</a></td>
